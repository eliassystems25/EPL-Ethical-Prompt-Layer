...
It introduces a safety-first decision-routing layer that reduces manipulative, harmful, or unstable instruction flows — without diminishing underlying model capability.

EPL does not replace AI intelligence. It structures how intelligence is applied.

## Governance Function
EPL functions as a behavioural governance routing layer.

It provides:
- Intent classification prior to response execution
- Behavioural risk categorisation (normal, sensitive, high-stakes, harmful)
- Structured guardrail application
- Refusal and redirection protocols
...
- Classifies behavioural risk categories
...
- Supports repair-loop reprocessing where required
...
EPL encodes a repeatable governance method — not a person, ideology, or belief system.
...
Within the Elias Systems governance architecture, EPL operates alongside:
